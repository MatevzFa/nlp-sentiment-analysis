...
#####################################################
    ...
    bert_embeddings_model.load_weights("models/pretrained_bert_embeddings_balanced/BertEmbeddingsSentiCoref")
    ...
    plt.savefig('report/figures/confmat_BertEmbeddingsSentiCoref_unbtest_128_15epochs.pdf', bbox_inches='tight')
